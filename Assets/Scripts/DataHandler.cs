...
public class DataHandler : MonoBehaviour
{
    ...
    private static string fileNameGameData = "GameData.json";
    private static string fileNameGameState = "GameState.json";
    private static string path;

    public GameData LoadGameData()
    {
        string filePath = Application.dataPath + "/" + fileNameGameData;
    ...
    {
        string filePath = Application.dataPath + "/" + fileNameGameState;
    ...
    public void SaveGameState(GameState gameData)
    {
